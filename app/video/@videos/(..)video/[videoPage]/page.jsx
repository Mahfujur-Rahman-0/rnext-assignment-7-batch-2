...
import getVideo from "@/app/video/video";
...
export default async function VideoPage({ params }) {
	...
	const item = videodata.find((e) => e.videoId === params.videoPage);
	if (!item) {
		notFound();
	}
	return (
		<a href="/" className="modal_wraper w-full fixed ">
			<div className="bg-color-bg mx-auto custom-box text-white font-exo w-4/6">
					...
					<main className="flex flex-col lg:flex-row gap-6">
						<div className="lg:w-3/4">
							...
							<h1 className="text-2xl font-bold mt-4">
								GTA V : BATMAN WAS KIDNAPPED || GTA V Bangla GAMEPLAY ||
								Professor Of Pc Gaming
							</h1>
